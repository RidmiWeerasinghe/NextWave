...
function SinglePlaylist() {
    const [{ accessToken, currentPlaylistsSpotify, searchResultsLoading , hidePlayer}, dispatch] = useStateValue()
    ...
    return (
        <div className='bg-darkBlue  overflow-hidden'>
            <div className="bg-darkBlue  overflow-hidden h-full">
                ...
                <section className={` pr-2 mx-12  ${hidePlayer ? "mb-5" : "mb-24"} mt-6 max-md:mx-2 overflow-y-scroll h-96 scrollbar scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-darkBlue`}>
